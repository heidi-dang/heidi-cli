				...
				{#each skills as item}
					<div class="rounded-xl px-2 py-1.5">
						<div class="flex items-center gap-2">
							<div
								class="min-w-0 flex-1 truncate font-mono text-[0.75rem] text-gray-900 dark:text-white"
							>
								{item.name}
							</div>
						...
						<div
							class="mt-0.5 line-clamp-2 text-[0.6875rem] leading-relaxed text-gray-500 dark:text-gray-400"
						>
							{item.description}
						</div>
					</div>
