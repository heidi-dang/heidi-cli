...
class UsageAnalytics:
    ...
    def record_request(self, model_id: str, request_tokens: int, 
                     response_tokens: int, response_time_ms: float, 
        ...
        with self._lock:
            try:
                with sqlite3.connect(self.db_path) as conn:
                    ...
                    """, (
                        model_id, model_id, model_id, request_tokens + response_tokens,
                        model_id, response_time_ms, model_id, response_time_ms,
                        model_id, float(success), model_id, int(not success)
                    ))
