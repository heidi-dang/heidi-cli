...
export function currentPluginUpdateManifest(env: NodeJS.ProcessEnv = process.env): PluginUpdateManifest {
  return {
    ...
    summary: "Heidi v2.1.5 restores the bounded ChatGPT Apps Workbench on the unchanged 26-tool compact MCP contract and syncs the latest audited CPTR upstream API/UI updates.",
    changes: [
