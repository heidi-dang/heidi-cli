...
6. the exact 30-tool MCP contract, exactly one bounded Apps Workbench resource with one UI-producing tool, and production-safe Workbench CSP using the adapter's deployed-contract verifier;
