...
def main():
    ...
    try:
        ...
        methods_to_test = ['ensure_dirs', 'load_config', 'save_config', 'get_github_token', 'set_github_token']
    ...
    try:
        ...
        total_tests += 1
        if hasattr(app, 'registered_commands') and any(cmd.name == 'setup' for cmd in app.registered_commands):
        ...
        total_tests += 1
        if hasattr(app, 'registered_groups') and any(group.name == 'openwebui' for group in app.registered_groups):
