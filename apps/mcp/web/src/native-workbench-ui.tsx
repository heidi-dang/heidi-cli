...
export function NativeWorkbenchStyles() {
  return <style>{`
    ...
    .cptr-status{display:inline-flex;align-items:center;gap:6px;font-size:12px;font-weight:650;white-space:nowrap}
    .cptr-dot{width:7px;height:7px;border-radius:50%;background:#12a150}.cptr-dot.wait{background:#d29922}.cptr-dot.bad{background:#d92d20}.cptr-dot.idle{background:color-mix(in srgb,CanvasText 30%,transparent)}
    ...
    @media(max-width:620px){.cptr-native{border-radius:14px}.cptr-native-head{padding:13px 13px 10px}.cptr-native-body{padding:0 13px 13px}.cptr-summary{grid-template-columns:1fr 1fr}.cptr-summary-main{grid-column:1/-1}.cptr-rail{grid-template-columns:1fr}.cptr-native-actions button:not(.primary){display:none}.cptr-native-foot{padding:9px 13px}.cptr-native-foot span{max-width:65%}}
